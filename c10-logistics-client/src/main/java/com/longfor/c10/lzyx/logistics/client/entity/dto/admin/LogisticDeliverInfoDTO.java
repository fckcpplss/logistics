...
public class LogisticDeliverInfoDTO {
     ...
     * 是否取消发货 1:是 0:否
     */
    @ApiModelProperty(value = "取消发货标志")
    private Boolean ifCancel;

    /**
     * 发件人地址id
     */
    @ApiModelProperty(value = "发货人地址id")
     ...
     * 发货人市名称
     */
    @ApiModelProperty(value = "发货人市名称")
    private String sendCity;

    /**
     * 发货人区名称
     */
    @ApiModelProperty(value = "发货人区名称")
